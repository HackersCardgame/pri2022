  ...
  def importDB(self, table):
    ...
    for file in self.files:
      ...
      for line in lines:
        ...
        if lineNumber % 100000 == 0: print("Imported: " + colored(str(lineNumber), "yellow") + " Errors: " + colored(str(errors), "red") + " inserted: " + colored(str(lineNumber-errors-1), "green") , end="\r", flush=True)
